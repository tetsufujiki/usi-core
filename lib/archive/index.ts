...
export const archiveItems: ArchiveItem[] = [
  {
    ...
    categoryLabel: "作編曲",
    roles: ["楽曲提供", "作曲", "編曲", "レコーディング", "ミックス", "マスタリング"],
    summary: "いきいき元気な町 山形県西川町。エクササイズ企画楽曲制作。",
    links: [
      {
        platform: "official",
        label: "制作記事",
  ...
  },
  {
    ...
    summary: "寺下真理子による「PIRATES OF THE CARIBBEAN」。編曲協力および、ミックス・マスタリングを担当。",
    links: [
      {
        platform: "youtube",
        label: "YouTube",
  ...
  },
  {
    ...
    date: "2025-11-01",
    workType: "artist-work",
    categories: ["arrangement", "recording", "mixing", "mastering", "label"],
    categoryLabel: "編曲・ミックス・マスタリング",
    roles: ["編曲", "レコーディング", "ミックス", "マスタリング"],
  ...
  },
  {
    ...
    date: "2014-04-11",
    workType: "label-work",
    categories: ["composition", "arrangement", "recording", "mixing", "mastering", "label"],
    roles: ["自社レーベル", "企画", "制作", "作曲", "編曲", "レコーディング", "ミックス", "マスタリング"],
  ...
  },
  {
    ...
    date: "2022-09-07",
    workType: "artist-work",
    categories: ["recording", "mixing", "mastering"],
    categoryLabel: "ミックス・マスタリング",
    roles: ["レコーディング", "ミックス", "マスタリング"],
  ...
  },
  {
    ...
    categoryLabel: "ミックス・マスタリング",
    roles: ["ミックス", "マスタリング"],
    summary: "ストーリー アドベンチャーゲーム。ミックス・マスタリングを担当。",
    format: "Game",
    links: [
      {
        platform: "official",
  ...
  },
  {
    ...
    summary: "レコーディング協力、ミックス・マスタリングを担当。",
    links: [
      {
        platform: "youtube",
        label: "YouTube",
  ...
  },
  {
    ...
    label: "Marmoset",
    workType: "licensing",
    categories: ["composition", "arrangement", "recording", "mixing", "mastering", "licensing"],
    roles: ["作品提供", "作曲", "編曲", "レコーディング", "ミックス", "マスタリング"],
  ...
  {
    id: "taka-80-dramatic-smooth-jazz-selection",
    title: "'80 Dramatic Smooth Jazz Selection feat.TakA",
    artist: "TakA",
    year: 2006,
    workType: "artist-work",
    categories: ["arrangement", "mixing"],
    categoryLabel: "編曲・ミックス",
    roles: ["編曲", "ミックス"],
    summary: "TakAのAlbum「'80 Dramatic Smooth Jazz Selection feat.TakA」。全曲を担当。",
    format: "Album",
    genre: "Smooth Jazz",
    artwork: "https://m.media-amazon.com/images/I/51NHTAMK3TL._AC_.jpg",
    links: [
      {
        platform: "other",
        label: "Amazonで見る",
        href: "https://www.amazon.co.jp/-/en/Dramatic-Smooth-Jazz-Selection-feat-Tak-Kawashima/dp/B000GFM8PO",
      },
    ],
  },
  {
